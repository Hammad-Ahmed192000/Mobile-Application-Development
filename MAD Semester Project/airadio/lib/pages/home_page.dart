...
class _HomePageState extends State<HomePage> {
  ...
  setupAlan(){
    AlanVoice.addButton(
        "f7f7de3a5115d4a1744ac55f490e86832e956eca572e1d8b807a3e2338fdd0dc/prod",
      ...
      body: Stack(
        children: [
          VxAnimatedBox()
              ...
              .make(),
            [AppBar(
            title: "Radio Application".text.xl4.bold.white.make().shimmer(primaryColor: Vx.purple300, secondaryColor: Colors.white),
          ...
          if (radios != null)
            VxSwiper.builder(
              ...
              onPageChanged: (index){
                  ...
                  final colorHex = int.tryParse(color);
              ...
              itemBuilder: (context, index) {
                ...
                return VxBox(
                  ...
                  [
                    ...
                    .p16();
              }).centered() else const Center(child: CircularProgressIndicator()),
          Align(
            alignment: Alignment.bottomCenter,
            child: [
              if(_isPlaying)
